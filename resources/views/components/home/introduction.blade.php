<section id="introduction" class="h-screen relative grid grid-cols-1 place-items-end items-center"
    ...
    <div class="grid grid-cols-2 w-11/12">
        ...
        <div class="w-9/12 mx-auto p-2 flex flex-col items-end justify-center space-y-4 bor ">
            <div class="border-2 border-black p-3 rounded-t-xl rounded-bl-xl bg-layout-gray bg-opacity-40 backdrop-filter backdrop-blur-lg divide-x divide-layout-red ">
    ...
    <div class="absolute bottom-0 right-0   ">
        <div class="border-2 border-black grid grid-cols-3 place-items-center p-3 rounded-tl-xl bg-layout-gray bg-opacity-40 backdrop-filter backdrop-blur-lg divide-x divide-layout-black ">
            ...
            <div class="flex flex-col items-center justify-center p-1 space-y-2 w-48 ">
                <svg class="flex-shrink-0 h-10 w-10 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
                </svg>

                <h1 class="font-bold text-yellow-custom">
                    50
                </h1>

                <h1 class="text-black font-bold">
                    Aktuální počet nabídek
                </h1>
            </div>
    ...
    <div class="absolute -right-60 top-52">
        <img src="{{ asset('src/bg/truck.png') }}"
            alt="3D náklaďák"
            class="w-5/12">
    </div>

    <div class="absolute bottom-0 left-0 w-3/12">
        <x-svg.garage/>
    </div>
