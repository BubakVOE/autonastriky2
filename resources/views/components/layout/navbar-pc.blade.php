<div class="fixed left-0 top-0 w-full bg-yellow-custom bg-opacity-80 py-10 z-20 backdrop-filter backdrop-blur-md">
...
{{-- offers --}}
            <div class="{{ active(['offers', 'offers/*', 'offer/*']) }} relative border-b-2 border-yellow-custom hover:border-b-2 hover:border-blue-custom transition duration-500 ease-in-out ">
                <a href="{{ route('offers') }}">
...
{{-- services --}}
            <div class="{{ active(['services', 'services/*']) }} relative border-b-2 border-yellow-custom hover:border-b-2 hover:border-blue-custom transition duration-500 ease-in-out ">
...
{{-- Sejít se --}}
            ...
            @guest
                <div class="relative ">
                    <button type="button" onclick="vipToggle()" class="uppercase bg-blue-custom rounded text-yellow-custom font-bold font-Rubik p-1 xl:text-xl xl:px-3 xl:py-2" aria-expanded="false">
                        <span>Sejít se</span>
                    </button>
...
{{-- kontakt --}}
            <div class="{{ active(['contacts', 'contacts/*']) }} relative border-b-2 border-yellow-custom hover:border-b-2 hover:border-blue-custom transition duration-500 ease-in-out ">
...
{{-- aboutMe --}}
            <div class="{{ active(['aboutMe', 'aboutMe/*']) }} relative border-b-2 border-yellow-custom hover:border-b-2 hover:border-blue-custom transition duration-500 ease-in-out ">
            ...
            @guest
                <div class="flex flex-col space-y-2 ">
                    <div class="flex justify-between">
                        ...
                        <a target="_blank" href="{{ route('dashboard-index') }}">
                            <img class="w-6" src="{{ asset('src/navbar/facebook.png') }}" alt="">
                        </a>

                        <a target="_blank" href="https://www.instagram.com/petrsitar_vojtareality/">
                    ...
                    <div class="lg:flex flex-row items-center justify-center">
