        ...
        <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8 m-10   ">
            ...
            @else
                <div class="lg:flex lg:items-center lg:justify-between group flex flex-col lg:h-96 bg-layout-red px-3 py-6 rounded-md space-y-4 transition duration-500 ease-in-out border-2 border-white">
                    ...
                    <div class=" h-full flex items-center justify-center">
                        <img src="{{ asset('posts/thumbNail/'.$posts[0]->cover) }}" style="width: 250px" class="object-center object-cover rounded-md">
                    </div>
            ...
            @else
                <div class="z-20 lg:flex lg:items-center lg:justify-between group flex flex-col lg:h-96 bg-white hover:bg-opacity-100 hover:bg-gray-400  backdrop-filter backdrop-blur-sm bg-opacity-70 px-3 py-6 rounded-md space-y-4 shadow-outSmaller transition duration-500 ease-in-out border border-gray-400 hover:shadow-none  transform hover:scale-95">
                    ...
                    <div class=" h-full flex items-center justify-center">
                        <img src="{{ asset('offers/thumbNail/'.$posts[1]->cover) }}" style="width: 200px" class="object-center object-cover">
                    </div>

                    <div class="text-center">
                        <span class="block">
                            <a href="{{ route('gallery-show',[$posts[1]->id, $posts[1]->city]) }}" class="inline-flex items-center px-6 py-2 rounded-md shadow-sm text-base font-medium text-blue-custom bg-yellow-custom group focus:outline-none">
            ...
            @else
                <div class="z-20 lg:flex lg:items-center lg:justify-between group flex flex-col lg:h-96 bg-layout-red hover:scale-105 border border-layout-white px-3 py-6 rounded-md space-y-4 shadow-outSmaller transition duration-500 ease-in-out transform">
                    ...
                    <div class=" h-full flex items-center justify-center">
                        <img src="{{ asset('offers/thumbNail/'.$posts[2]->cover) }}" style="width: 200px" class="object-center object-cover">
                    </div>

                    <div class="text-center">
                        <span class="block">
                            <a href="{{ route('gallery-show',[$posts[2]->id, $posts[2]->city]) }}" class="inline-flex items-center px-6 py-2 rounded-md shadow-sm text-base font-medium text-blue-custom bg-yellow-custom group focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="-ml-1 mr-2 h-5 w-5 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                </svg>
                                Detaily
