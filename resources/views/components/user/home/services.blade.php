<section id="services" class="pb-24 relative">
    ...
    <div class="grid grid-cols-3 place-items-center  py-10  ">
        ...
        <div class="grid grid-cols-3 place-items-center gap-x-16 p-3 ">

            <div class="border-2 border-white flex flex-col items-center justify-center p-5 space-y-2 w-48 bg-layout-red rounded-lg hover:scale-105 transition duration-500 ease-in-out shadow-xl cursor-default ">
