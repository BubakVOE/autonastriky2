    ...
    <nav id="navbar" class="fixed left-0 top-0 w-full bg-opacity-80 z-20 backdrop-filter bg-layout-black py-6">
        <div class="grid grid-cols-3 place-items-center  ">
            ...
            <div class="flex items-center justify-center space-x-8">
                ...
                <div class="{{ active(['/']) }} relative border-b border-layout-white hover:border-layout-red transition duration-500 ease-in-out ">
                ...
                <div class="{{ active(['galerie', 'galerie/*']) }} relative border-b border-layout-white hover:border-layout-red transition duration-500 ease-in-out ">
                    <a class="xl:uppercase font-bold xl:text-xl font-Rubik text-layout-white"
                ...
                <div class="{{ active(['sluzby', 'sluzby/*']) }} relative border-b border-layout-white hover:border-layout-red transition duration-500 ease-in-out ">
                    <a class="xl:uppercase font-bold xl:text-xl font-Rubik text-layout-white"
                ...
                <div class="{{ active(['kontakty', 'kontakty/*']) }} relative border-b border-layout-white hover:border-layout-red transition duration-500 ease-in-out ">
                    <a class="xl:uppercase font-bold xl:text-xl font-Rubik text-layout-white"
